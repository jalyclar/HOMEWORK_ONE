...
class homework_one:
    ...
    def write_file(self):
        ascii.write([self.x,[self.y_values[func] for func in self.y_values]], 'exampledata.txt', names=['x',f'{func}(x)' for func in self.y_values])
        print('Data written to exampledata.txt')
